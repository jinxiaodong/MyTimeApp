 ...
 * @author Cody.yi
 *         扩展第三方下拉刷新库
 *         PullToRefreshWithHorFrameLayout 内嵌横向RecycleView时使用，解决滑动冲突问题
 * @see com.project.xiaodong.mytimeapp.frame.view.recycleview.LoadMoreWithHorRecycleView 结合使用
 */
public class PullToRefreshWithHorFrameLayout extends PullToRefreshFrameLayout {
     ...
     *******************************************************************************/
    public PullToRefreshWithHorFrameLayout(Context context) {
        super(context);
    }

    public PullToRefreshWithHorFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PullToRefreshWithHorFrameLayout(Context context, AttributeSet attrs, int defStyle) {
