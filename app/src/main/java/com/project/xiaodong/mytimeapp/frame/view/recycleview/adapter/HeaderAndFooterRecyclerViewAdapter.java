package com.project.xiaodong.mytimeapp.frame.view.recycleview.adapter;
...
/**
 * RecyclerView添加Header/Footer适配器
 */
...
//                    final GridLayoutManager.SpanSizeLookup mSpanSizeLookup = gridLayoutManager.getSpanSizeLookup();
                    ...
                    gridLayoutManager.setSpanSizeLookup(new GridLayoutManager.SpanSizeLookup() {
                        ...
                        public int getSpanSize(int position) {
                            ...
                            return 1;
//                            return mSpanSizeLookup.getSpanSize(position - getHeadersCount());
                        }
                    });
