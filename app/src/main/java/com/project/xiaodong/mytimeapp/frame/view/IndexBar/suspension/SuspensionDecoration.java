package com.project.xiaodong.mytimeapp.frame.view.IndexBar.suspension;
...
public class SuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    public SuspensionDecoration setColorTitleBg(String colorTitleBg) {
        COLOR_TITLE_BG = Color.parseColor(colorTitleBg);
        return this;
    }

    public SuspensionDecoration setColorTitleFont(String colorTitleFont) {
        COLOR_TITLE_FONT = Color.parseColor(colorTitleFont);
        return this;
    }
...
/*
        ...
        c.drawText(mDatas.get(position).getSuspensionTag(), child.getPaddingLeft() + DeviceUtil.dip2px(mContext, leftMargin), child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
...
//        c.drawText(tag, child.getPaddingLeft()+ + DeviceUtil.dip2px(mContext, leftMargin),
