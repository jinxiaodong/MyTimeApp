...
public class SharePreferenceUtil {
	...
	private WeakReference<Context> contextRef = new WeakReference<Context>(context);
	private Editor editor = null;
	public static String FILENAME = "share_prefers";
	private int mode = Context.MODE_PRIVATE;
	SharedPreferences sp;
	private static SharePreferenceUtil mSp = null;

	
	public static synchronized SharePreferenceUtil getInstance(Context context) {
		if (mSp == null) {
			mSp = new SharePreferenceUtil(context);
		}
		return mSp;
	}
