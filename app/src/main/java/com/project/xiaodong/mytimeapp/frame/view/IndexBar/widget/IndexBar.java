package com.project.xiaodong.mytimeapp.frame.view.IndexBar.widget;
...
import com.project.xiaodong.mytimeapp.frame.view.IndexBar.helper.IIndexBarDataHelper;
...
public class IndexBar extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(Color.parseColor("#419bf9"));
