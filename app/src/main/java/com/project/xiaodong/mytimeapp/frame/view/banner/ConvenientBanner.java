package com.project.xiaodong.mytimeapp.frame.view.banner;
...
import com.project.xiaodong.mytimeapp.frame.view.banner.adapter.CBPageAdapter;
import com.project.xiaodong.mytimeapp.frame.view.banner.holder.CBViewHolderCreator;
import com.project.xiaodong.mytimeapp.frame.view.banner.listener.CBPageChangeListener;
import com.project.xiaodong.mytimeapp.frame.view.banner.listener.OnItemClickListener;
import com.project.xiaodong.mytimeapp.frame.view.banner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setOffscreenPageLimit(int pages) {
        if (viewPager != null) {
