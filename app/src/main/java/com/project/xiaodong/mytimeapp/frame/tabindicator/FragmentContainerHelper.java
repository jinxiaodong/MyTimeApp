...
public class FragmentContainerHelper {
    private List<TabIndicatorLayout> mTabIndicatorLayouts = new ArrayList<TabIndicatorLayout>();
    ...
    public FragmentContainerHelper(TabIndicatorLayout tabIndicatorLayout) {
        mTabIndicatorLayouts.add(tabIndicatorLayout);
    }
    ...
    public void attachMagicIndicator(TabIndicatorLayout tabIndicatorLayout) {
        mTabIndicatorLayouts.add(tabIndicatorLayout);
    }

    private void dispatchPageSelected(int pageIndex) {
        for (TabIndicatorLayout tabIndicatorLayout : mTabIndicatorLayouts) {
            tabIndicatorLayout.onPageSelected(pageIndex);
        }
    }
