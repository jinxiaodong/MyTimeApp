...
//            value = item.toString();
            MTimeCityInfo mTimeCityInfo = (MTimeCityInfo) item;
            value = mTimeCityInfo.getSuspensionTag();
        }
...
//            string = item.toString();
            MTimeCityInfo mTimeCityInfo = (MTimeCityInfo) item;
            string = mTimeCityInfo.getSuspensionTag();
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (item instanceof CharSequence) {
            ...
            MTimeCityInfo mTimeCityInfo = (MTimeCityInfo) item;
//            i =;
            holder.textView.setText(mTimeCityInfo.n);
        }
